...
<center><h2>OUR BESTSELLER</h1></center>
<div class="product-container">
<?php
// Hardcoded array of bestselling products
$bestsellers = [
    ["name" => "Nike Air Forces", "price" => 200, "image" => "images/AFS.png", "link" => "products/AirForce.php"],
    
];

foreach ($bestsellers as $product) { ?>
    <div class="col-md-4 product-list-item">
        <a href="/Software dev/<?php echo $product['link']; ?>">
            <center><img src="/Software dev/<?php echo $product['image']; ?>" alt="<?php echo $product['name']; ?>" class="img"></center>
        </a>
