...
class Shoe {
    ...
    <div class='product-card'>
        <div class='product-image'>
            <img src='/Version7/" . htmlspecialchars($this->getImagePath()) . "' alt='" . htmlspecialchars($this->getName()) . "' />
        </div>
        <div class='product-info'>
            ...
            <div class='cart-btn'>
                <a href='addToCart.php?productID=" . htmlspecialchars($this->getproductID()) . "'>Add to Cart</a>
            </div>
        </div>
    </div>";
    }
